...
## DB Assignments  [![Build Status](https://travis-ci.org/Honey-badger1/db-assignments.svg?branch=master)](https://travis-ci.org/Honey-badger1/db-assignments)
...
```
* Open https://github.com/Honey-badger1/db-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
